...
exports.getPlaces = async (req, res, next) => {
	...
	if (city) {
		try {
			places = await Place.find({ city: city });
		} catch (err) {
			return next(
...
exports.updatePlaceById = async (req, res, next) => {
	...
	updatedPlace.address = req.body.address;
	updatedPlace.price = req.body.price;
	updatedPlace.numberOfGuests = req.body.numberOfGuests;
	updatedPlace.numberOfRooms = req.body.numberOfRooms;
	updatedPlace.numberOfbeds = req.body.numberOfbeds;
	updatedPlace.placeType = req.body.placeType;
	updatedPlace.city = req.body.city;
