            ...
            <div className="row">
              <div className="col-md-4 text-center mb-3">
                <div className="card">
                  ...
                  <div className="card-title">
                    <h5 className="">
                      Airbnb Delivers $2.6 Billion in Taxes to Governments
                      Around the World
                    </h5>
                  </div>
                  <div className="card-body">
                    <p>
                      ...
                      share of taxes. We are collecting and remitting taxes in
                      more than 650 jurisdictions, covering thousands of cities.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 text-center mb-3">
                <div className="card">
                  ...
                  <div className="card-body">
                    <p>
                      New Year’s Eve will be a bit different from years’ past,
                      that doesn’t mean it can’t be celebrated together. Here
                      are 10 Online Experiences to help groups celebrate the
                      occasion.
                    </p>
                  </div>
                </div>
