      ...
      <div className="container text-center">
        <div className="w-50 m-auto p-3">
          ...
          <p>
            ...
            frontline responders, so they can stay close to their work or safely
          ...
          <div className="sectionone py-5">
            ...
            <div className="row p-3">
                <div className="col-md m-auto">
                    ...
                    <p>Hosts are offering free and discounted places to stay to people working on the frontlines. We’re also waiving service fees on all Frontline stays.
To access a stay, you’ll need to answer a few questions to make sure you’re eligible. Once that’s done, you’ll be able to see the stays available in your area</p>
                </div>
                <div className="col-md">
            ...
            <div className="row p-3">
                ...
                <div className="col-md m-auto">
                    ...
                    <p>We want people to feel comfortable hosting and booking stays right now. That’s why we worked with healthcare experts to create an extensive cleaning checklist that will help hosts prepare before each stay.</p>
                </div>
            </div>
        </div>
      </div>
