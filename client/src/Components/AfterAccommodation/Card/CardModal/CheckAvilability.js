 ...
 const [booking,setBooking]=useState(true);
    ...
    return(
      ...
      >
        ...
        <div className="container">
            {booking?
                <div className="row justify-content-center">
                    <FcOk className="col-12 mb-5" style={{fontSize:"4.5rem"}}/>
        ...
        <button className="mainForm__button col-5" onClick={bookHandler}>Book Now</button>
          <Button className="col-5 p-2 btn btn-secondary"  onClick={props.onHide} >Close</Button>
        </Modal.Footer>
      </Modal>
    )
}
